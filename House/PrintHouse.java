...
public static int membersInNeighborhood;
    ...
    public void actionPerformed(ActionEvent evt) {
                                ...
                                if (buildHouse.isSelected()) {
                                                ...
                                                houseBasement.setSelected(false);

                                                houseGarage.setSelected(false);

                                                houseLaundryRoom.setSelected(false);

                                                squareFeet.setText(null);

                                                windowNumber.setText(null);

                                                houseLocation.setText(null);

                                                houseBedrooms.setText(null);

                                                houseFloors.setText(null);

                                                houseBathrooms.setText(null);

                                                houseStyle.setText(null);
